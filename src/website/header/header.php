...
<nav class="row">
	...
	<div class="col-2 d-flex justify-content-center">
		<!-- language select -->
		<div class="dropdown">
			<a class="nav-link dropdown-toggle custom-lang-toggle" data-mdb-toggle="dropdown" aria-expanded="false">
			...
			<ul class="dropdown-menu" aria-labelledby="Dropdown">
				...
				foreach ($otherLangOptions as $otherLangOption) {
					echo '<li>
						<a class="dropdown-item custom-lang-select"
							onclick="selectLang(\'' . $page . '\', \'' . $otherLangOption->code . '\')"
						>
